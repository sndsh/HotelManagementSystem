    ...
    public partial class addedPictureEntities : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Pictures", t => t.PictureID, cascadeDelete: true)
                .ForeignKey("dbo.tblAccomodation", t => t.AccomodationID, cascadeDelete: true)
        ...
        {
            DropForeignKey("dbo.AccomodationPictures", "AccomodationID", "dbo.tblAccomodation");
            DropForeignKey("dbo.AccomodationPictures", "PictureID", "dbo.Pictures");
            DropForeignKey("dbo.AccomodationPackagePictures", "AccomodationPackageID", "dbo.tblAccomodationPackage");
